...
class TestAdditionalEndpoints:
    ...
    def test_update_responsible_success(self, client, mock_session):
    ...
    def test_delete_responsible_success(self, client, mock_session):
    ...
    def test_assign_responsible_success(self, client, mock_session):
    ...
    def test_search_people(self, client, mock_session):
        """Тест поиска людей."""
        with patch(
            "src.presentation.web.routes.api.get_database"
        ) as mock_get_db, patch(
    ...
    def test_generate_greeting_success(self, client, mock_session):
    ...
    def test_create_card_success(self, client, mock_session):
    ...
    def test_generate_greeting_not_found(self, client, mock_session):
    ...
    def test_create_birthday_validation_error(self, client, mock_session):
    ...
    def test_delete_birthday_not_found(self, client, mock_session):
